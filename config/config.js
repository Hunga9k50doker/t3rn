...
const settings = {
  ...
  CAMPAIGNS: process.env.CAMPAIGNS ? JSON.parse(process.env.CAMPAIGNS.replace(/'/g, '"')) : [],
  ...
  BASE_URL: process.env.BASE_URL ? process.env.BASE_URL : "https://quest.somnia.network/api",
  RPC_URL: process.env.RPC_URL ? process.env.RPC_URL : "https://b2n.rpc.caldera.xyz/http",
  BASE_URL_V2: process.env.BASE_URL_V2 ? process.env.BASE_URL_V2 : "https://somnia-poc.w3us.site/api/v2",

  REF_CODE: process.env.REF_CODE ? process.env.REF_CODE : "2AE9F3B1",
  ...
  TIMES_SWAP: process.env.TIMES_SWAP && _isArray(process.env.TIMES_SWAP) ? JSON.parse(process.env.TIMES_SWAP) : [1, 15],
  AMOUNT: process.env.AMOUNT && _isArray(process.env.AMOUNT) ? JSON.parse(process.env.AMOUNT) : [0, 1],
